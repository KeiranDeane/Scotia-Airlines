...
public class UserInterface 
{
	...
	public void DisplayChangeStatusMenu(String FlightInfo)
	{
		//create frame object and size
				...
				JButton btnFlightClosed = new JButton("Flight Closed");
				...
				btnSeatsAvailable.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						if(chosenFlight.isFull() == false)
						{
							...
							chosenFlight.setStatusMessage("Seats Available");
				...
				btnCheckingIn.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						checkingIn = true;
							...
							chosenFlight.setStatusMessage("Checking In");
				...
				btnFlightClosed.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						checkingIn = false;
							...
							chosenFlight.setCheckingIn(checkingIn);
							chosenFlight.setClosed(closed);
							chosenFlight.setStatusMessage("Closed");
				...
				btnBoarding.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						checkingIn = false;
							...
							chosenFlight.setCheckingIn(checkingIn);
							chosenFlight.setClosed(closed);
							chosenFlight.setStatusMessage("Flight Boarding");
...
////////////////////////////////////////Action Listeners///////////////////////////////////////////////////////////////		
		...
		cancel.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					genericOutput("Cancellations not available. Flight is" + chosenFlight.getStatusMessage());
		...
		reserve.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					genericOutput("Reservations not available. Flight is" + chosenFlight.getStatusMessage());
		...
		booking.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(boarding == true  || closed == true || full == true)
				{
					...
					genericOutput("Bookings not available. Flight is " + chosenFlight.getStatusMessage());
